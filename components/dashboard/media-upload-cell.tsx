  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <button
        ...
        className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full border border-border text-muted-foreground motion-safe:transition-colors hover:border-accent hover:text-accent-ink disabled:opacity-50"
        aria-label={
          error
