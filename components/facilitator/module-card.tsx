...
export function ModuleCard({ module, lang, onOpen }: ModuleCardProps) {
  const translation =
  ...
  return (
    <button
      ...
      className="rounded-2xl border border-border bg-background p-4 text-left motion-safe:transition motion-safe:active:scale-[0.99]"
    >
